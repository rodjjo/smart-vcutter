...
void ClippingRender::render(ClippingKey key, uint8_t *source_buffer, uint32_t target_w, uint32_t target_h, uint8_t *buffer, bool transparent) {
...
void ClippingRender::render_transparent(ClippingKey key, uint8_t *player_buffer, uint8_t *buffer) {
    render(
        key,
        player_buffer,
        w(),
