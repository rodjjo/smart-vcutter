 ...
 */
#ifndef SMART_VCUTTER_VIEWER_EDITOR_ROTATE_OPERATION_H_
#define SMART_VCUTTER_VIEWER_EDITOR_ROTATE_OPERATION_H_
...
#endif  // SMART_VCUTTER_VIEWER_EDITOR_ROTATE_OPERATION_H_
